...
public class TradesFuturesIncrementalMessageHandler implements MessageHandler {

    private static final Logger LOGGER = LoggerFactory.getLogger(TradesFuturesIncrementalMessageHandler.class);
