...
public class FastService {
    ...
    private static final int WAIT_FOR_XML_FILE_PERIOD_MS = 1000;
    ...
    private final Thread initThread = new Thread() {
        ...
        public void run() {
            ...
            while (initThreadContinueWorking) {
                ...
                if (templatesXmlFile.isFile()) {
                    ...
                    try {
                        templates = xmlMessageTemplateLoader.load(new FileInputStream(templatesXmlFile));
